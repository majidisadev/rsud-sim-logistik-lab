  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[100] focus:px-4 focus:py-2.5 focus:bg-white focus:text-primary focus:rounded-lg focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:outline-none transition-colors font-medium"
      >
