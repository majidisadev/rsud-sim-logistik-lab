...
export default function BarangKeluar() {
  ...
  const totalKeluar = allTransactions.reduce((sum, tx) => sum + (tx.quantity || 0), 0);
    ...
    <div ref={pageRef} className="space-y-5" role="main" aria-label="Halaman Barang Keluar">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-amber-100 text-amber-600" aria-hidden>
            <ArrowUpCircle className="w-6 h-6" />
          </div>
          <div>
            <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Barang Keluar</h1>
            <p className="text-sm text-gray-500 mt-0.5">Kelola transaksi barang keluar dari gudang</p>
          </div>
        </div>
        <Button
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div className="flex items-center gap-3 p-4 sm:p-5 rounded-xl bg-white border border-gray-100 shadow-sm">
          ...
          <div>
            <p className="text-sm text-gray-500 font-medium">Jumlah Keluar</p>
      ...
      <div
        ...
        role="search"
        aria-label="Filter transaksi barang keluar"
      >
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            <label htmlFor="filter-item-keluar" className="block mb-2 text-sm font-medium text-gray-700">
              Barang
            </label>
            <select
              id="filter-item-keluar"
              value={filterItem}
              onChange={(e) => setFilterItem(e.target.value)}
              className="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors"
            >
          ...
          <div>
            <label htmlFor="filter-start-keluar" className="block mb-2 text-sm font-medium text-gray-700">
              Tanggal Mulai
            </label>
            <Input
          ...
          <div>
            <label htmlFor="filter-end-keluar" className="block mb-2 text-sm font-medium text-gray-700">
              Tanggal Akhir
            </label>
            <Input
          ...
          <div>
            <label htmlFor="items-per-page-keluar" className="block mb-2 text-sm font-medium text-gray-700">
              Tampilan per halaman
            </label>
            <select
              id="items-per-page-keluar"
              value={itemsPerPage}
              onChange={(e) => {
      ...
      <div
        ...
        role="region"
        aria-label="Tabel transaksi barang keluar"
      >
        <div className="overflow-x-auto">
          <table className="w-full" role="table" aria-label="Daftar transaksi barang keluar">
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) => {
                ...
                if (found) {
                  setForm({ ...form, item_id: found.id.toString() });
                  fetchItems();
                }
              }}
            />
